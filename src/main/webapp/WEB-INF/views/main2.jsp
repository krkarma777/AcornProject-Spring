	...
	<div class="container-fluid" style="height: 100%; width: 100%;">
		<div class="d-flex align-content-center justify-content-center"
			...
			<div class="align-self-center" style="background-color: transparent;">
				<a href="MoveToContentsHomeServlet"><img class="rounded-2"
			...
			<div class="align-self-center px-5"
				...
				<a href="ContentsHome.jsp?content=drama"><img class="rounded-2"
					src="images/tv.png" width="250px" height="250px"></a>
			</div>
			<div class="align-self-center" style="background-color: transparent">
				<a href="ContentsHome.jsp?content=book"><img class="rounded-2"
