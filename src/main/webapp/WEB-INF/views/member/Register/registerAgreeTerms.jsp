    ...
    <div class="container">
        ...
        <form id="agreementForm" action="<c:url value='/CheckExistUser'/>" method="post">
            ...
            <div>
                ...
                <label><input type="checkbox" class="checkboxes" name="checked_Agreement">이용 약관에 동의합니다.</label>
            </div>
            ...
            <div>
                ...
                <label><input type="checkbox" class="checkboxes" name="checked_Info">개인정보 처리방침에 동의합니다.</label>
            </div>
            ...
            <div>
                ...
                <label><input type="checkbox" class="checkboxes" name="checked_Withdraw">회원 탈퇴 및 서비스 이용 중지에 동의합니다.</label>
            </div>
            <br>
